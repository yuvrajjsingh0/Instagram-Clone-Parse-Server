package com.gohibo.album.Core.view.widget;
...
public class AspectRatioTextView extends TextView {
    ...
    public AspectRatioTextView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.imgcrop_AspectRatioTextView);
        init(a);
    }
    ...
    private void init(@NonNull TypedArray a) {
        ...
        mAspectRatioTitle = a.getString(R.styleable.imgcrop_AspectRatioTextView_imgcrop_artv_ratio_title);
        mAspectRatioX = a.getFloat(R.styleable.imgcrop_AspectRatioTextView_imgcrop_artv_ratio_x, CropImageView.SOURCE_IMAGE_ASPECT_RATIO);
        mAspectRatioY = a.getFloat(R.styleable.imgcrop_AspectRatioTextView_imgcrop_artv_ratio_y, CropImageView.SOURCE_IMAGE_ASPECT_RATIO);
        ...
        mDotSize = getContext().getResources().getDimensionPixelSize(R.dimen.imgcrop_size_dot_scale_text_view);
        mDotPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        mDotPaint.setStyle(Paint.Style.FILL);

        setTitle();

        int activeColor = getResources().getColor(R.color.imgcrop_color_widget_active);
        applyActiveColor(activeColor);
    ...
    private void applyActiveColor(@ColorInt int activeColor) {
        ...
        ColorStateList textViewColorStateList = new ColorStateList(
                ...
                new int[]{
                        activeColor,
                        ContextCompat.getColor(getContext(), R.color.imgcrop_color_widget)
                }
        );
