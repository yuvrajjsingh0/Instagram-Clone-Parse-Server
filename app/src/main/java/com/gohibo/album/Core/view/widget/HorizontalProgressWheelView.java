...
public class HorizontalProgressWheelView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        mProgressLinePaint.setColor(getResources().getColor(R.color.imgcrop_color_progress_wheel_line));
    ...
    private void init() {
        mMiddleLineColor = ContextCompat.getColor(getContext(), R.color.imgcrop_color_progress_wheel_line);

        mProgressLineWidth = getContext().getResources().getDimensionPixelSize(R.dimen.imgcrop_width_horizontal_wheel_progress_line);
        mProgressLineHeight = getContext().getResources().getDimensionPixelSize(R.dimen.imgcrop_height_horizontal_wheel_progress_line);
        mProgressLineMargin = getContext().getResources().getDimensionPixelSize(R.dimen.imgcrop_margin_horizontal_wheel_progress_line);
