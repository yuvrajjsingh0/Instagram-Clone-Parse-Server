...
import com.gohibo.album.Core.model.CropParameters;
import com.gohibo.album.Core.model.ImageState;
import com.gohibo.album.Core.task.BitmapCropTask;
import com.gohibo.album.Core.util.CubicEasing;
...
public class CropImageView extends TransformImageView {
    ...
    protected void processStyledAttributes(@NonNull TypedArray a) {
        float targetAspectRatioX = Math.abs(a.getFloat(R.styleable.imgcrop_imgcropView_imgcrop_aspect_ratio_x, DEFAULT_ASPECT_RATIO));
        float targetAspectRatioY = Math.abs(a.getFloat(R.styleable.imgcrop_imgcropView_imgcrop_aspect_ratio_y, DEFAULT_ASPECT_RATIO));
